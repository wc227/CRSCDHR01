...
class Position(models.Model):
    ...
    position_name = models.CharField('岗位名称', max_length=10)
    position_type = models.CharField('岗位类型', max_length=10, choices=TYPE_CHOICES, default='综合管理')
    ...
    exp_req = models.IntegerField('工作年限', choices=EXP_CHOICES, default=0)
    edu_req = models.CharField('学历要求', max_length=10, choices=EDU_CHOICES, default=0,)
    num = models.IntegerField('招聘人数', default=1)
    position_detail = models.TextField('岗位描述', max_length=500)
    position_req = models.TextField('岗位要求', max_length=500)
...
class PositionFav(models.Model):
    """职位收藏"""
    position = models.ForeignKey(Position, related_name="position_fav_foreignkey", on_delete=models.CASCADE)
